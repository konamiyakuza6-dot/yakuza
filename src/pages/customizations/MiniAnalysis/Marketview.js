...
export default function SignalTool({ 
  ...
  // Use the shared props instead of local state
  ...
  <div className="dt-input-stack">
        ...
        {loading ? (
          ...
          <main className="dt-content-grid">
           ...
           <span className="live-btn-price"> <strong > {currentPrice}</strong></span>
                    ...
                    <div className="dt-metrics-inline">
                      {Object.entries(stats)
                        ...
                        .map(([key, val]) => {
                          ...
                          const colorClass = percentage > 54 ? 'txt-green' : percentage < 40 ? 'txt-red' : '';
                          return (
